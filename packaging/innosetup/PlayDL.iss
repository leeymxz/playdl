...
; Always show the directory page: a previous install would otherwise skip it (DisableDirPage=auto skips when a previous dir is known).
DisableDirPage=no
UsePreviousAppDir=yes
DefaultGroupName={#MyAppName}
AllowNoIcons=yes
OutputDir=..\dist
OutputBaseFilename=PlayDL-{#MyAppVersion}-windows-x64-setup
...
UninstallDisplayIcon={app}\playdl.ico
