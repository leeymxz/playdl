...
$relId = 388167112  # v0.3.4 release

$uploads = @(
    @{ File = "$dir\packaging\dist\PlayDL-0.3.4-windows-x64-setup.exe"; Name = "PlayDL-0.3.4-windows-x64-setup.exe" },
    @{ File = "$dir\dist\playdl-0.3.4-windows-amd64.zip"; Name = "playdl-0.3.4-windows-amd64.zip" },
